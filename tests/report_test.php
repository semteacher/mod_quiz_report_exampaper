...
require_once($CFG->dirroot . '/mod/quiz/report/exampaper/report.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quiz_exampaper_report_testcase extends advanced_testcase {
    ...
    public function test_report_sql() {
        ...
        // Set the options.
        $reportoptions = new quiz_exampaper_options('overview', $quiz, $cm, null);
        ...
        $table = new quiz_exampaper_table($quiz, $context, $qmsubselect, $reportoptions,
    ...
    public function test_get_bands_count_and_width($grade, $expected) {
        ...
        $this->assertEquals($expected, quiz_exampaper_report::get_bands_count_and_width($quiz));
    }
